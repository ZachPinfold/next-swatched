...
const UploadImage = ({ color }: AssetType) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      ...
      <g>
        <path
          className="st0"
          fill={color}
          d="M5.7,38.7c9.4,0,18.8,0,28.2,0c0-0.2,0-0.4,0-0.6c0-2.3,0-4.5,0-6.8c0-1.2,0.4-2.2,1.6-2.8
        ...
        <path
          className="st0"
          fill={color}
          d="M22.7,9.8c0,0.2,0,0.4,0,0.5c0,6.4,0,12.7,0,19.1c0,1.1-0.4,2.1-1.4,2.7c-1.9,1.1-4.2-0.1-4.3-2.4
