...
const CopySwatch = ({ color }: AssetType) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      ...
      <g>
        <path
          fill={color}
          className="st0"
          d="M0.05,48.89c0-10.37,0-20.74,0-31.1c0-4.38,2.15-6.52,6.54-6.52c18.1,0,36.21,0.06,54.31-0.05
        ...
        <path
          fill={color}
          className="st0"
          d="M71.14,7.46c-0.75,0-1.33,0-1.91,0c-17.02,0-34.04,0-51.06,0c-0.59,0-1.19,0.02-1.77-0.04
